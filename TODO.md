...
- [ ] optimize `getAll()` of `Lists` and `DocumentsIndex`
- [ ] Disallow duplicates, Support caching entire channels listing , support periodic incremental sneaky update of cache with videos from whitelisted channels.
